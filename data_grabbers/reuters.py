...
def removeUnwantedUrls(articles):
    ...
    for article in articles:
        if re.search('reuters.com/video',   article.url) \
            or re.search('jp.reuters.com',  article.url) \
            or re.search('cn.reuters.com',  article.url) \
            or not re.search('reuters.com', article.url):
            continue
