...
def removeUnwantedUrls(articles):
    ...
    for article in articles:
        if not re.search('dailymail.co.uk',         article.url) \
        or re.search('dailymail.co.uk/sport',       article.url) \
        or re.search('dailymail.co.uk/health',      article.url) \
        or re.search('dailymail.co.uk/money',       article.url) \
        or re.search('dailymail.co.uk/tvshowbiz',   article.url) \
        or re.search('dailymail.co.uk/sciencetech', article.url) \
        or re.search('dailymail.co.uk/femail',      article.url) \
        or re.search('#comments',                   article.url) \
        or re.search('dailymail.co.uk/video',       article.url):
            continue
